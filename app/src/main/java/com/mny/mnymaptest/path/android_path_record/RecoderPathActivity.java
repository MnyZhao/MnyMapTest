...
import com.mny.mnymaptest.path.recorduitl.Util;
...
public class RecoderPathActivity extends Activity implements LocationSource,
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (btn.isChecked()) {
                    ...
                    mTraceClient.queryProcessedTrace(2, Util.parseTraceLocationList(record.getPathline()), LBSTraceClient.TYPE_AMAP, RecoderPathActivity.this);
    ...
    protected void saveRecord(List<AMapLocation> list, String time) {
        if (list != null && list.size() > 0) {
            ...
            Toast.makeText(RecoderPathActivity.this, "没有记录到路径", Toast.LENGTH_SHORT)
                    .show();
        }
    }
...
//		}
    ...
    public void record(View view) {
        Intent intent = new Intent(RecoderPathActivity.this, RecordActivity.class);
        ...
        if (lineID == 1) {
            if (linepoints != null && linepoints.size() > 0) {
                ...
                if (mlocMarker == null) {
                    ...
                    Toast.makeText(RecoderPathActivity.this, "距离" + mDistance, Toast.LENGTH_SHORT).show();
