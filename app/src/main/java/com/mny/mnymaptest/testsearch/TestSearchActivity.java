package com.mny.mnymaptest.testsearch;
...
public class TestSearchActivity extends FragmentActivity implements
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(TestSearchActivity.this, infomation);
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    for(PoiItem poiItem:poiItems){
                        Log.e("PoiItem", "onPoiSearched: "+poiItem.getWebsite() );
                    }
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        ToastUtil.show(TestSearchActivity.this,
                                R.string.no_result);
                    }
                }
            } else {
