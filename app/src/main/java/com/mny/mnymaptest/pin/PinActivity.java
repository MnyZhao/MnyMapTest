...
public class PinActivity extends AppCompatActivity implements LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView = (MapView) findViewById(R.id.map_pin);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(PinActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(PinActivity.this, inputquery);
    ...
    private void init() {
        ...
        aMap.setOnCameraChangeListener(new AMap.OnCameraChangeListener() {
            ...
            public void onCameraChangeFinish(CameraPosition cameraPosition) {
                ...
                Log.e("getScalePerPixel", "onCameraChangeFinish: " + aMap.getScalePerPixel());
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(PinActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(PinActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(PinActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(PinActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
